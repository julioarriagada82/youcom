    ...
    public class ArchivoDAL
    {
        ...
        public static bool Insert(YouCom.DTO.ArchivoDTO myArchivoDTO)
        {
            ...
            try
            {
                ...
                wobjSQLHelper.SetParametro("@pIdCondominio", SqlDbType.Decimal, -1, myArchivoDTO.IdCondominio);
                wobjSQLHelper.SetParametro("@pIdCategoria", SqlDbType.Decimal, -1, myArchivoDTO.IdCategoria);
