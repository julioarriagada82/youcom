...
namespace YouCom.DAL
{
    public class ComentarioAvisoDAL
    {
        ...
        public static bool Delete(YouCom.DTO.ComentarioAvisoDTO myComentarioAvisoDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ActivaComentarioAviso(YouCom.DTO.ComentarioAvisoDTO theComentarioAvisoDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ValidaEliminacionComentarioAviso(YouCom.DTO.ComentarioAvisoDTO theComentarioAvisoDTO, ref DataTable pobjDatatable)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
            wobjSQLHelper.SetParametro("@pIdComentarioAviso", SqlDbType.VarChar, 20, theComentarioAvisoDTO.IdComentarioAviso);
