    ...
    public class DirectivaDAL
    {
        ...
        public static bool Insert(YouCom.DTO.DirectivaDTO myDirectivaDTO)
        {
            ...
            try
            {
                //Seteo Parámetros.
                //====================================================================================
                wobjSQLHelper.SetParametro("@pIdCargo", SqlDbType.Decimal, -1, myDirectivaDTO.IdCargo);
                wobjSQLHelper.SetParametro("@pIdCondominio", SqlDbType.Decimal, -1, myDirectivaDTO.IdCondominio);
                ...
                wobjSQLHelper.SetParametro("@pApellidoDirectiva", SqlDbType.VarChar, 200, myDirectivaDTO.ApellidoDirectiva);
