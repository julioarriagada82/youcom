...
namespace YouCom.DAL
{
    public class FrecuenciaDAL
    {
        ...
        public static bool Insert(YouCom.DTO.FrecuenciaDTO myFrecuenciaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool Update(YouCom.DTO.FrecuenciaDTO myFrecuenciaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool Delete(YouCom.DTO.FrecuenciaDTO myFrecuenciaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ActivaFrecuencia(YouCom.DTO.FrecuenciaDTO theFrecuenciaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
