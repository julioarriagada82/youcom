...
namespace YouCom.DAL
{
    public class GastosComunesDAL
    {
        ...
        public static bool Insert(YouCom.DTO.GastosComunesDTO myGastosComunesDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool Delete(YouCom.DTO.GastosComunesDTO myGastosComunesDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ActivaGastoComun(YouCom.DTO.GastosComunesDTO theGastosComunesDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
