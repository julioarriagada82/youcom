...
namespace YouCom.DAL
{
    public class TipoAvisoDAL
    {
        ...
        public static bool Update(YouCom.DTO.TipoAvisoDTO myTipoAvisoDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool Delete(YouCom.DTO.TipoAvisoDTO myTipoAvisoDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ActivaTipoAviso(YouCom.DTO.TipoAvisoDTO theTipoAvisoDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ValidaEliminacionTipoAviso(DTO.TipoAvisoDTO theTipoAvisoDTO, ref DataTable pobjDatatable)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
