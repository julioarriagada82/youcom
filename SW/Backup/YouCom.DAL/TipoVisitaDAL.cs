...
namespace YouCom.DAL
{
    public class TipoVisitaDAL
    {
        ...
        public static bool Insert(YouCom.DTO.TipoVisitaDTO myTipoVisitaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool Update(YouCom.DTO.TipoVisitaDTO myTipoVisitaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool Delete(YouCom.DTO.TipoVisitaDTO myTipoVisitaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ActivaTipoVisita(YouCom.DTO.TipoVisitaDTO theTipoVisitaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ValidaEliminacionTipoVisita(DTO.TipoVisitaDTO theTipoVisitaDTO, ref DataTable pobjDatatable)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
