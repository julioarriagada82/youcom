...
namespace YouCom.bll
{
    public class TipoAvisoBLL
    {
        ...
        public static bool Delete(DTO.TipoAvisoDTO myTipoAvisoDTO)
        {
            bool resultado = TipoAvisoDAL.Delete(myTipoAvisoDTO);
            return resultado;
        }

        public static bool Insert(DTO.TipoAvisoDTO myTipoAvisoDTO)
        {
            bool resultado = TipoAvisoDAL.Insert(myTipoAvisoDTO);
            return resultado;
        }

        public static bool Update(DTO.TipoAvisoDTO myTipoAvisoDTO)
        {
        ...
        {
            bool respuesta = YouCom.DAL.TipoAvisoDAL.ActivaTipoAviso(theTipoAvisoDTO);
            return respuesta;
        }
