    ...
    public class AreasComunesDAL
    {
        ...
        public static bool Insert(YouCom.DTO.AreasComunesDTO myAreasComunesDTO)
        {
            ...
            try
            {
                ...
                wobjSQLHelper.SetParametro("@pIdCondominio", SqlDbType.Decimal, -1, myAreasComunesDTO.TheCondominioDTO.IdCondominio);
                wobjSQLHelper.SetParametro("@pIdComunidad", SqlDbType.Decimal, -1, myAreasComunesDTO.TheComunidadDTO.IdComunidad);
                //====================================================================================
