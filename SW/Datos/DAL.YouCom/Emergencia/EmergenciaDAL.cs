...
namespace YouCom.DAL.Emergencia
{
    public class EmergenciaDAL
    {
        ...
        public static bool Insert(YouCom.DTO.Emergencia.EmergenciaDTO myEmergenciaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
            ...
            try
            {
                ...
                wobjSQLHelper.SetParametro("@pIdTipoEmergencia", SqlDbType.Decimal, -1, myEmergenciaDTO.TheTipoEmergenciaDTO.IdTipoEmergencia);
                ...
                wobjSQLHelper.SetParametro("@pIdCondominio", SqlDbType.Decimal, -1, myEmergenciaDTO.TheCondominioDTO.IdCondominio);
                wobjSQLHelper.SetParametro("@pIdComunidad", SqlDbType.Decimal, -1, myEmergenciaDTO.TheComunidadDTO.IdComunidad);
                //====================================================================================
        ...
        public static bool Update(YouCom.DTO.Emergencia.EmergenciaDTO myEmergenciaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool Delete(YouCom.DTO.Emergencia.EmergenciaDTO myEmergenciaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ActivaEmergencia(YouCom.DTO.Emergencia.EmergenciaDTO theEmergenciaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ValidaEliminacionEmergencia(YouCom.DTO.Emergencia.EmergenciaDTO theEmergenciaDTO, ref DataTable pobjDatatable)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
