...
namespace YouCom.DAL.Propietario
{
    public class FamiliaDAL
    {
        ...
        public static bool Insert(YouCom.DTO.Propietario.FamiliaDTO myFamiliaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
            ...
            try
            {
                ...
                wobjSQLHelper.SetParametro("@pIdCasa", SqlDbType.Decimal, -1, myFamiliaDTO.TheCasaDTO.IdCasa);
        ...
        public static bool Delete(YouCom.DTO.Propietario.FamiliaDTO myFamiliaDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ValidaEliminacionFamilia(DTO.Propietario.FamiliaDTO theFamiliaDTO, ref DataTable pobjDatatable)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
