...
namespace YouCom.DAL.Propietario
{
    public class ParentescoDAL
    {
        ...
        public static bool Insert(YouCom.DTO.Propietario.ParentescoDTO myParentescoDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool Update(YouCom.DTO.Propietario.ParentescoDTO myParentescoDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool Delete(YouCom.DTO.Propietario.ParentescoDTO myParentescoDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ActivaParentesco(YouCom.DTO.Propietario.ParentescoDTO theParentescoDTO)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
        ...
        public static bool ValidaEliminacionParentesco(DTO.Propietario.ParentescoDTO theParentescoDTO, ref DataTable pobjDatatable)
        {
            bool retorno = false;
            YouCom.Service.BD.SQLHelper wobjSQLHelper = new YouCom.Service.BD.SQLHelper();
