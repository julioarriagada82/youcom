    ...
    public class TurnoDiarioDAL
    {
        ...
        public static bool Insert(YouCom.DTO.TurnoDiarioDTO myTurnoDiarioDTO)
        {
            ...
            try
            {
                //Seteo Parámetros.
                //====================================================================================
                wobjSQLHelper.SetParametro("@pIdPortero", SqlDbType.Decimal, -1, myTurnoDiarioDTO.ThePorteriaDTO.IdPorteria);
                wobjSQLHelper.SetParametro("@pIdHorario", SqlDbType.Decimal, -1, myTurnoDiarioDTO.TheHorarioTurnoDTO.IdHorarioTurno);
