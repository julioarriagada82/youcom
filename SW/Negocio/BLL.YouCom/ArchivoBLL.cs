...
namespace YouCom.bll
{
    public class ArchivoBLL
    {
        ...
        public static IList<ArchivoDTO> getListadoArchivoByCondominioByComunidad(decimal idCondominio, decimal idComunidad)
        {
            var archivo = listaArchivoActivo().Where(x => x.TheCondominioDTO.IdCondominio == idCondominio && x.TheComunidadDTO.IdComunidad == idComunidad).ToList();
            return archivo;
        }
