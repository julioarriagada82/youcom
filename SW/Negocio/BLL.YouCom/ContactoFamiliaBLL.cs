...
namespace YouCom.bll
{
    public class ContactoFamiliaBLL
    {
        ...
        public static IList<ContactoFamiliaDTO> getListadoContactoFamiliaByCondominioByComunidad(decimal idCondominio, decimal idComunidad)
        {
            var contacto = listaContactoFamiliaActivo().Where(x => x.TheCondominioDTO.IdCondominio == idCondominio && x.TheComunidadDTO.IdComunidad == idComunidad).ToList();
            return contacto;
        }

        public static IList<ContactoFamiliaDTO> getListadoContactoFamiliaByCasa(decimal idCondominio, decimal idComunidad, decimal idCasa)
        {
            var contacto = listaContactoFamiliaActivo().Where(x => x.TheCondominioDTO.IdCondominio == idCondominio && x.TheComunidadDTO.IdComunidad == idComunidad && x.TheCasaDTO.IdCasa == idCasa).ToList();
            return contacto;
        }
