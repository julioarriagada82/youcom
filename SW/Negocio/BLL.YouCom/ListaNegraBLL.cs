...
namespace YouCom.bll
{
    public class ListaNegraBLL
    {
        ...
        public static IList<ListaNegraDTO> getListadoListaNegraByCondominioByComunidad(decimal idCondominio, decimal idComunidad)
        {
            var listas = listaListaNegraActivo().Where(x => x.TheCondominioDTO.IdCondominio == idCondominio && x.TheComunidadDTO.IdComunidad == idComunidad).ToList();
            return listas;
        }
