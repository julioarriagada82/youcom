...
namespace YouCom.bll
{
    public class PeriodoHorarioBLL
    {
        ...
        public static IList<PeriodoHorarioDTO> getListadoPeriodoHorarioByCondominioByComunidad(decimal idCondominio, decimal idComunidad)
        {
            var periodos = listaPeriodoHorarioActivo().Where(x => x.TheCondominioDTO.IdCondominio == idCondominio && x.TheComunidadDTO.IdComunidad == idComunidad).ToList();
            return periodos;
        }
        ...
        {
            bool respuesta = PeriodoHorarioDAL.ActivaPeriodoHorario(thePeriodoHorarioDTO);
            return respuesta;
        }
