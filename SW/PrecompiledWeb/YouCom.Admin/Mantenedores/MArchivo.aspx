<%@ page language="C#" masterpagefile="~/App_Master/Home.master" autoeventwireup="true" inherits="Mantenedores_MArchivo, App_Web_y4k0mwx9" title="Untitled Page" enableEventValidation="false" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtArchivoTitulo" runat="server" Width="500px" TextMode="SingleLine"
                    MaxLength="200" />
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtArchivoDescripcion" runat="server" Width="500px" TextMode="SingleLine"
                    MaxLength="200" />
