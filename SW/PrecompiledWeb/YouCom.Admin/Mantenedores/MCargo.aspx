<%@ page title="" language="C#" masterpagefile="~/App_Master/Home.master" autoeventwireup="true" inherits="Mantenedores_MCargo, App_Web_y4k0mwx9" enableEventValidation="false" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <asp:Panel runat="server" ID="pnlAdministracionCargo">
        <h2>
            Listado de Cargos</h2>
        <asp:Repeater ID="rptCargo" OnItemCommand="rptCargo_OnItemCommand" runat="server">
            <HeaderTemplate>
            ...
            <ItemTemplate>
                <tr>
                    <td class="w10 txt-left">
                        <%# DataBinder.Eval(Container.DataItem, "IdCargo")%>
                    </td>
                    <td class="w20 txt-left">
                        <%# DataBinder.Eval(Container.DataItem, "NombreCargo")%>
                    </td>
                    <td class="w10">
                    ...
                    <td class="w10">
                        ...
                        <asp:HiddenField ID="hdnIdCargo" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IdCargo")%>' />
                    </td>
                    <td class="w10">
    ...
    <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
        ...
        <asp:HiddenField runat="server" ID="HdnIdCargo" />
    </asp:Panel>
</asp:Content>
