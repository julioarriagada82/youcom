<%@ page title="" language="C#" masterpagefile="~/App_Master/Home.master" autoeventwireup="true" inherits="Mantenedores_MTipoCategoria, App_Web_y4k0mwx9" enableEventValidation="false" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <asp:Panel runat="server" ID="pnlAdministracionCasa">
        <h2>
            Listado de Tipo de Categoria</h2>
