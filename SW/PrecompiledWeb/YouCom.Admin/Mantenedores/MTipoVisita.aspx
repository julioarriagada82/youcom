<%@ page title="" language="C#" masterpagefile="~/App_Master/Home.master" autoeventwireup="true" inherits="Mantenedores_MTipoVisita, App_Web_y4k0mwx9" enableEventValidation="false" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <asp:Panel runat="server" ID="pnlAdministracionCasa">
        <h2>
            Listado de Tipo Visita</h2>
        <asp:Repeater ID="rptTipoVisita" OnItemCommand="rptTipoVisita_OnItemCommand" runat="server">
            <HeaderTemplate>
            ...
            <ItemTemplate>
                <tr>
                    <td class="w10 txt-left">
                        <%# DataBinder.Eval(Container.DataItem, "IdTipoVisita")%>
                    </td>
                    <td class="w20 txt-left">
                        <%# DataBinder.Eval(Container.DataItem, "NombreTipoVisita")%>
                    </td>
                    <td class="w10">
                    ...
                    <td class="w10">
                        ...
                        <asp:HiddenField ID="hdnIdTipoVisita" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IdTipoVisita")%>' />
                    </td>
                    <td class="w10">
    ...
    <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
        <asp:Repeater ID="rptTipoVisitaInactivo" OnItemCommand="rptTipoVisitaInactivo_OnItemCommand"
            runat="server">
            <HeaderTemplate>
                <div class="conte_box_white">
                    <div class="conte_tabla_datos_body_detail ">
        ...
        <asp:HiddenField runat="server" ID="hdnIdTipoVisita" />
    </asp:Panel>
</asp:Content>