<%@ Page Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true"
    CodeFile="MFuncionTipo.aspx.cs" Inherits="Administracion_MFuncionTipo" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <asp:Panel ID="pnlProducto" runat="server" Visible="true">
        <asp:Panel runat="server" ID="pnlAdministracionFuncionTipo">
            <asp:Label runat="server" ID="lblPopUp"></asp:Label>
            <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="true"
                ShowSummary="false" />
            <div class="tit_box_white">
                Mantenedor de Tipos de Funciones
            </div>
            <div class="conte_box_whitetabs">
                ...
                <div class="columna-right">
                    <asp:TextBox runat="server" ID="txtTipoFuncion" CssClass="texto_option" MaxLength="20"></asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Custom, Numbers, LowercaseLetters, UppercaseLetters"
                        TargetControlID="txtTipoFuncion" ValidChars=" ;:*.,-_|#$%/()[]{}¿?¡!">
                    </cc1:FilteredTextBoxExtender>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTipoFuncion"
                        Display="None" ErrorMessage="Tipo Funcion es campo Obligatorio."></asp:RequiredFieldValidator>
                </div>
                <div class="mt10">
            ...
            <asp:Repeater ID="rptTipoFuncion" OnItemCommand="rptTipoFuncion_OnItemCommand" runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <th class="w10 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "FuncionTipoCod")%>
                        </th>
                        <th class="w20 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "FuncionTipoNombre")%>
                        </th>
                        <th class="w10">
                        ...
                        <th class="w10">
                            ...
                            <asp:HiddenField ID="hdnDescripcion" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "FuncionTipoNombre")%>' />
                            <asp:HiddenField ID="HdnTipoSistema" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "FuncionTipoCod")%>' />
                        </th>
                        <th class="w10">
            ...
            <asp:HiddenField runat="server" ID="HidIdTipoFuncion" />
        </asp:Panel>
        <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
            <asp:Repeater ID="rptTipoFuncionInactivo" OnItemCommand="rptTipoFuncionInactivo_OnItemCommand"
                runat="server">
                <HeaderTemplate>
                    <div class="conte_box_white">
                        <div class="conte_tabla_datos_body_detail ">
