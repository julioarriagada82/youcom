<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true" CodeFile="MMensajePorteria.aspx.cs" Inherits="Admin_Administracion_MMensajePorteria" %>
    ...
    <asp:Panel ID="pnlProducto" runat="server" Visible="true">
        ...
        <div class="conte_box_whitetabs">
            ...
            <div class="columna-right">
                <asp:DropDownList runat="server" ID="ddlPorteria" CssClass="select_option">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlPorteria"
                    Display="None" ErrorMessage="La Porteria es Obligatoria.">*</asp:RequiredFieldValidator>
            </div>
            <div class="columna-left-160">
                <p>
                    Fecha
        ...
        <asp:Panel runat="server" ID="pnlAdministracionMensajePorteria">
            <h2>Listado de Mensajes</h2>
            <asp:Repeater ID="rptMensajePorteria" OnItemCommand="rptMensajePorteria_OnItemCommand" runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <th class="w10">
                            ...
                            <asp:HiddenField ID="hdnIdMensajePorteria" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IdMensajePorteria")%>' />
                        </th>
                        <th class="w10">
        ...
        <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
            <asp:Repeater ID="rptMensajePorteriaInactivo" OnItemCommand="rptMensajePorteriaInactivo_OnItemCommand"
                runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <td class="w20 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "NombreMensajePorteria")%>
                        </td>
                        <td class="w10">
                            <%# DataBinder.Eval(Container.DataItem, "DireccionMensajePorteria")%>
                        </td>
                        <td class="w10">
                            <%# DataBinder.Eval(Container.DataItem, "fechaIngreso")%>
                        </td>
            ...
            <asp:HiddenField runat="server" ID="hdnIdMensajePorteria" />
        </asp:Panel>
    </asp:Panel>
