<%@ Page Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true" CodeFile="MArchivo.aspx.cs" Inherits="Admin_Mantenedores_MArchivo" Title="Untitled Page" %>
    ...
    <div id="conte">
        ...
        <div class="conte_box_whitetabs">
            ...
            <div class="columna-right">
                <asp:TextBox ID="txtArchivoTitulo" runat="server" CssClass="texto_option"
                    MaxLength="200" />
                <asp:RequiredFieldValidator ID="RFVTxtContTitulo" runat="server" ControlToValidate="txtArchivoTitulo"
                    Display="None" ErrorMessage="Ingrese Titulo por favor" />
                <cc1:FilteredTextBoxExtender ID="FTEBannerNombre" runat="server" TargetControlID="txtArchivoTitulo"
            ...
            <div class="columna-right">
                <asp:TextBox ID="txtArchivoDescripcion" runat="server" CssClass="texto_option"
                    MaxLength="200" />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtArchivoDescripcion"
                    Display="None" ErrorMessage="Ingrese Descripcion Archivo por favor" />
                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtArchivoDescripcion"
                    ValidChars=" ;:*.,-_|#$%/()[]{}¿?¡!áéíóúñÑ<>" FilterType="Custom, Numbers, LowercaseLetters, UppercaseLetters">
                </cc1:FilteredTextBoxExtender>
            </div>
            ...
            <div class="columna-right">
                <asp:FileUpload ID="FileArchivo" runat="server" TabIndex="2" CssClass="select_option" /><br />
        ...
        <asp:Panel runat="server" ID="pnlAdministracionArchivo">
            <asp:Repeater ID="rptArchivo" OnItemCommand="rptArchivo_OnItemCommand" runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <th class="w20 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "ArchivoTitulo")%>
                        </th>
                        <th class="w10">
                        ...
                        <th class="w10">
                            ...
                            <asp:HiddenField ID="hdnArchivoId" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ArchivoId")%>' />
                        </th>
                        <th class="w10">
        ...
        <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
            <asp:Repeater ID="rptArchivoInactivo" OnItemCommand="rptArchivoInactivo_OnItemCommand"
                runat="server">
                <HeaderTemplate>
            ...
            <asp:HiddenField runat="server" ID="hdnArchivoId" />
        </asp:Panel>
    </div>
        </asp:Panel>
