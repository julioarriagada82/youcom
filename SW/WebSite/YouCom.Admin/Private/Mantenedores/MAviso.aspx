<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true" CodeFile="MAviso.aspx.cs" Inherits="Admin_Mantenedores_MAviso" %>
        ...
        <div id="conte">
            ...
            <div class="conte_box_whitetabs">
                ...
                <div class="columna-right">
                    <asp:TextBox ID="txtAvisoTitulo" runat="server" TextMode="SingleLine" CssClass="texto_option"
                        MaxLength="300" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtAvisoTitulo"
                        Display="None" ErrorMessage="Ingrese Titulo por favor" />
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" TargetControlID="txtAvisoTitulo"
                ...
                <div class="columna-right">
                    <asp:TextBox ID="txtAvisoDescripcion" runat="server" CssClass="texto_option" TextMode="MultiLine"
                        MaxLength="200" Columns="100" Rows="10" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtAvisoDescripcion"
                        Display="None" ErrorMessage="Ingrese Descripción por favor" />
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" TargetControlID="txtAvisoDescripcion"
                        ValidChars=" ;:*.,-_|#$%/()[]{}¿?¡!áéíóúñÑ<>" FilterType="Custom, Numbers, LowercaseLetters, UppercaseLetters">
                    </cc1:FilteredTextBoxExtender>
                </div>
                <div class="borde_bottom cf">
                ...
                <div class="columna-right">
                    <asp:FileUpload ID="FileImagenAviso" runat="server" TabIndex="2" CssClass="select_option" /><br />
                ...
                <div class="columna-right">
                    <asp:DropDownList runat="server" ID="ddlTipoAviso" CssClass="select_option">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlTipoAviso"
                        Display="None" ErrorMessage="Tipo Aviso es campo Obligatorio."></asp:RequiredFieldValidator>
                </div>
                <div class="borde_bottom cf">
                </div>
                <div class="columna-left-160">
                ...
                <div class="columna-right">
                    <asp:TextBox ID="txtAvisoPrecio" runat="server" TextMode="SingleLine" MaxLength="200" CssClass="texto_option" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtAvisoPrecio"
                        Display="None" ErrorMessage="Ingrese precio por favor" />
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" TargetControlID="txtAvisoPrecio"
                        ValidChars=" ;:*.,-_|#$%/()[]{}¿?¡!áéíóúñÑ<>" FilterType="Custom, Numbers, LowercaseLetters, UppercaseLetters">
                    </cc1:FilteredTextBoxExtender>
                </div>
                <div class="borde_bottom cf">
                ...
                <asp:Panel ID="pnlEstado" runat="server" Visible="false">
                    ...
                    <div class="columna-right">
                        <asp:TextBox ID="txtMotivoEstado" runat="server" CssClass="texto_option" TextMode="MultiLine"
            ...
            <asp:Panel runat="server" ID="pnlAdministracionAviso">
                <asp:Repeater ID="rptAviso" OnItemCommand="rptAviso_OnItemCommand" runat="server">
                    <HeaderTemplate>
                            ...
                            <div class="conte_tabla_datos_body_detail ">
                                <table class="tabla_datos_top" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <th class="w10 titulos">Tipo Aviso
                                        </th>
                                        <th class="w10 titulos">Precio
                                        </th>
                                        <th class="w10 titulos">Familia
                                        </th>
                                        <th class="w10 titulos">Estado
                                        </th>
                    ...
                    <ItemTemplate>
                        <tr>
                            <th class="w10 txt-left">
                                <%# DataBinder.Eval(Container.DataItem, "TituloAviso")%>
                            </th>
                            <th class="w10">
                                <%# DataBinder.Eval(Container.DataItem, "TheTipoAvisoDTO.NombreTipoAviso")%>
                            </th>
                            <th class="w10">
                                <%# DataBinder.Eval(Container.DataItem, "PrecioAviso")%>
                            </th>
                            <th class="w10">
                                <%# DataBinder.Eval(Container.DataItem, "TheFamiliaDTO.NombreCompleto")%>
                            </th>
                            <th class="w10">
                                <%# DataBinder.Eval(Container.DataItem, "TheAvisosEstadoDTO.NombreAvisoEstado")%>
                            </th>
                            <th class="w10">
                            ...
                            <th class="w10">
                                <asp:LinkButton ID="LnkBtnEditar" CausesValidation="false" runat="server" ToolTip="Editar Aviso"
            ...
            <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
                <asp:Repeater ID="rptAvisoInactivo" OnItemCommand="rptAvisoInactivo_OnItemCommand"
                    runat="server">
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td class="w20 txt-left">
                                <%# DataBinder.Eval(Container.DataItem, "NombreAviso")%>
                            </td>
                            <td class="w10">
                                <%# DataBinder.Eval(Container.DataItem, "DireccionAviso")%>
                            </td>
                            <td class="w10">
                                <%# DataBinder.Eval(Container.DataItem, "fechaIngreso")%>
                            </td>
                ...
                <asp:HiddenField runat="server" ID="hdnIdAviso" />
            </asp:Panel>
        </div>
    </asp:Panel>
