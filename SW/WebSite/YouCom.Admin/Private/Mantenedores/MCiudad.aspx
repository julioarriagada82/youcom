<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true" CodeFile="MCiudad.aspx.cs" Inherits="Admin_Mantenedores_MCiudad" %>
    ...
    <asp:Panel ID="pnlProducto" runat="server" Visible="true">
        <div id="conte">
            ...
            <asp:Panel runat="server" ID="pnlAdministracionCasa">
                <asp:Repeater ID="rptCiudad" OnItemCommand="rptCiudad_OnItemCommand" runat="server">
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            <th class="w10 txt-left">
                                <%# DataBinder.Eval(Container.DataItem, "IdCiudad")%>
                            </th>
                            <th class="w20 txt-left">
                                <%# DataBinder.Eval(Container.DataItem, "NombreCiudad")%>
                            </th>
                            <th class="w20 txt-left">
                                <%# DataBinder.Eval(Container.DataItem, "TheRegionDTO.NombreRegion")%>
                            </th>
                            <th class="w10">
                            ...
                            <th class="w10">
                                ...
                                <asp:HiddenField ID="hdnIdCiudad" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IdCiudad")%>' />
                            </th>
                            <th class="w10">
            ...
            <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
                <asp:Repeater ID="rptCiudadInactivo" OnItemCommand="rptCiudadInactivo_OnItemCommand"
                    runat="server">
                    <HeaderTemplate>
                ...
                <asp:HiddenField runat="server" ID="hdnIdCiudad" />
            </asp:Panel>
        </div>
    </asp:Panel>
