<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true" CodeFile="MComuna.aspx.cs" Inherits="Admin_Mantenedores_MComuna" %>
    ...
    <asp:Panel ID="pnlProducto" runat="server" Visible="true">
        ...
        <div class="conte_box_whitetabs">
            ...
            <div class="columna-right">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlCiudad"
        ...
        <asp:Panel runat="server" ID="pnlAdministracionCasa">
            <asp:Repeater ID="rptComuna" OnItemCommand="rptComuna_OnItemCommand" runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <th class="w10 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "IdComuna")%>
                        </th>
                        <th class="w20 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "NombreComuna")%>
                        </th>
                        <th class="w20 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "TheCiudadDTO.NombreCiudad")%>
                        </th>
                        <th class="w10">
                        ...
                        <th class="w10">
                            ...
                            <asp:HiddenField ID="hdnIdComuna" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IdComuna")%>' />
                        </th>
                        <th class="w10">
        ...
        <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
            <asp:Repeater ID="rptComunaInactivo" OnItemCommand="rptComunaInactivo_OnItemCommand"
                runat="server">
                <HeaderTemplate>
            ...
            <asp:HiddenField runat="server" ID="hdnIdComuna" />
        </asp:Panel>
