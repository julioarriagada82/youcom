<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true" CodeFile="MEmergencia.aspx.cs" Inherits="Admin_Mantenedores_MEmergencia" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <asp:Panel ID="pnlProducto" runat="server" Visible="true">
        ...
        <div class="conte_box_whitetabs">
            ...
            <div class="columna-right">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlTipo"
                    Display="None" ErrorMessage="El Tipo de Emergencia es Obligatorio.">*</asp:RequiredFieldValidator>
            </div>
            ...
            <div class="columna-right">
                <asp:TextBox runat="server" ID="txtDescripcion" Width="310px" MaxLength="30" TextMode="MultiLine" Rows="20"></asp:TextBox>
        ...
        <asp:Panel runat="server" ID="pnlAdministracionEmergencia">
            <asp:Repeater ID="rptEmergencia" OnItemCommand="rptEmergencia_OnItemCommand" runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <th class="w10 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "IdEmergencia")%>
                        </th>
                        <th class="w20 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "NombreEmergencia")%>
                        </th>
                        <th class="w10">
                        ...
                        <th class="w10">
                            ...
                            <asp:HiddenField ID="hdnIdEmergencia" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IdEmergencia")%>' />
                        </th>
                        <th class="w10">
        ...
        <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
            <asp:Repeater ID="rptEmergenciaInactivo" OnItemCommand="rptEmergenciaInactivo_OnItemCommand"
                runat="server">
                <HeaderTemplate>
            ...
            <asp:HiddenField runat="server" ID="hdnIdEmergencia" />
        </asp:Panel>
    </asp:Panel>
