<%@ Page Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true"
    CodeFile="MEvento.aspx.cs" Inherits="Admin_Mantenedores_MEvento" Title="Untitled Page" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <asp:Panel ID="pnlProducto" runat="server" Visible="true">
        ...
        <div class="conte_box_whitetabs">
            ...
            <div class="columna-right">
                <asp:TextBox ID="txtEventoTitulo" runat="server" Width="500px" TextMode="SingleLine"
                    MaxLength="200" />
            ...
            <div class="columna-right">
                <asp:TextBox ID="txtEventoResumen" runat="server" Width="500px" TextMode="MultiLine" Rows="20"
                    MaxLength="200" />
            ...
            <div class="columna-right">
                <asp:FileUpload ID="FileImagenEvento" runat="server" TabIndex="2" CssClass="select_option" /><br />
