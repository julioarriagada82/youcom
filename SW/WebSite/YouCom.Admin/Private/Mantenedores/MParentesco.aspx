<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true" CodeFile="MParentesco.aspx.cs" Inherits="Admin_Mantenedores_MParentesco" %>
    ...
    <asp:Panel ID="pnlProducto" runat="server" Visible="true">
        ...
        <div class="conte_box_whitetabs">
            ...
            <div class="columna-right">
                <asp:TextBox runat="server" MaxLength="50" ID="txtNombre" Width="210px" Height="18px"></asp:TextBox>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtNombre"
                    Display="None" ErrorMessage="Ocupación es campo Obligatorio."></asp:RequiredFieldValidator>
            </div>
            <div class="mt10">
        ...
        <asp:Panel runat="server" ID="pnlAdministracionParentesco">
            <asp:Repeater ID="rptParentesco" OnItemCommand="rptParentesco_OnItemCommand" runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <th class="w10 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "IdParentesco")%>
                        </th>
                        <th class="w20 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "NombreParentesco")%>
                        </th>
                        <th class="w10">
                        ...
                        <th class="w10">
                            ...
                            <asp:HiddenField ID="hdnIdParentesco" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IdParentesco")%>' />
                        </th>
                        <th class="w10">
        ...
        <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
            <asp:Repeater ID="rptParentescoInactivo" OnItemCommand="rptParentescoInactivo_OnItemCommand"
                runat="server">
                <HeaderTemplate>
            ...
            <asp:HiddenField runat="server" ID="hdnIdParentesco" />
        </asp:Panel>
