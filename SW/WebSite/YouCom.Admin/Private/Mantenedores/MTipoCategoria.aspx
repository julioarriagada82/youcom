<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true" CodeFile="MTipoCategoria.aspx.cs" Inherits="Admin_Mantenedores_MTipoCategoria" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <asp:Panel ID="pnlProducto" runat="server" Visible="true">
        ...
        <div class="tit_box_white">
            Mantenedor de Tipo de Categoría
        </div>
        ...
        <asp:Panel runat="server" ID="pnlAdministracionCasa">
            <asp:Repeater ID="rptTipoCategoria" OnItemCommand="rptTipoCategoria_OnItemCommand" runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <th class="w10 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "IdTipoCategoria")%>
                        </th>
                        <th class="w20 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "NombreTipoCategoria")%>
                        </th>
                        <th class="w10">
                        ...
                        <th class="w10">
                            ...
                            <asp:HiddenField ID="hdnIdTipoCategoria" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IdTipoCategoria")%>' />
                        </th>
                        <th class="w10">
        ...
        <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
            <asp:Repeater ID="rptTipoCategoriaInactivo" OnItemCommand="rptTipoCategoriaInactivo_OnItemCommand"
                runat="server">
                <HeaderTemplate>
            ...
            <asp:HiddenField runat="server" ID="hdnIdTipoCategoria" />
        </asp:Panel>
