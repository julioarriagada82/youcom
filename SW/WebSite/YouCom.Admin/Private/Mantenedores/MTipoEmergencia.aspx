<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Admin/Home.master" AutoEventWireup="true" CodeFile="MTipoEmergencia.aspx.cs" Inherits="Admin_Mantenedores_MTipoEmergencia" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <asp:Panel ID="pnlProducto" runat="server" Visible="true">
        ...
        <div class="tit_box_white">
            Mantenedor de Tipo de Emergencia
        </div>
        ...
        <asp:Panel runat="server" ID="pnlAdministracionCasa">
            <asp:Repeater ID="rptTipoEmergencia" OnItemCommand="rptTipoEmergencia_OnItemCommand" runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <th class="w10 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "IdTipoEmergencia")%>
                        </th>
                        <th class="w20 txt-left">
                            <%# DataBinder.Eval(Container.DataItem, "NombreTipoEmergencia")%>
                        </th>
                        <th class="w10">
                        ...
                        <th class="w10">
                            ...
                            <asp:HiddenField ID="hdnIdTipoEmergencia" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IdTipoEmergencia")%>' />
                        </th>
                        <th class="w10">
        ...
        <asp:Panel ID="pnlPapelera" runat="server" Visible="false">
            <asp:Repeater ID="rptTipoEmergenciaInactivo" OnItemCommand="rptTipoEmergenciaInactivo_OnItemCommand"
                runat="server">
                <HeaderTemplate>
            ...
            <asp:HiddenField runat="server" ID="hdnIdTipoEmergencia" />
        </asp:Panel>
