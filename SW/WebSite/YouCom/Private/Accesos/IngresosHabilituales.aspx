<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Home.master" AutoEventWireup="true" CodeFile="IngresosHabilituales.aspx.cs" Inherits="Privado_Accesos_IngresosHabilituales" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:MultiView ID="mvwAutorizaciones" runat="server">
        <asp:View ID="View1" runat="server">
            <h1 class="page-header">Ingresos Habituales</h1>
        ...
        <asp:View ID="View2" runat="server">
            <div class="col-lg-8">
                <h1 class="page-header">Agregar Ingreso Habitual</h1>
                <form>
