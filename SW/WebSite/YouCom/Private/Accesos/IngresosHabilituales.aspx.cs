...
public partial class Privado_Accesos_IngresosHabilituales : Intermedia.IMSystem.Navigation.Page.WebPage
{
    private const string retorno1 = "IngresosHabilituales.aspx";
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["idAccesoHabitual"] != null)
            {
                getObtieneDetalleAcceso(Session["idAccesoHabitual"].ToString());

                Session.Remove("idAccesoHabitual");
            }
            else
            {
                cargarTipoVisita();
    ...
    protected bool setEnviaIngresoHabitual()
    {
        ...
        myFrecuenciaDTO.IdFrecuencia = 1;
