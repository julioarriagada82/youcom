<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Home.master" AutoEventWireup="true" CodeFile="MensajeriaInterna.aspx.cs" Inherits="Privado_Contacto_MensajeriaInterna" %>
        ...
        <fieldset class="form-group">
            ...
            <div class="radio radiobuttonlist col-sm-12 col-md-10">
                <asp:CheckBoxList ID="rblSemana" runat="server" RepeatDirection="Vertical" RepeatLayout="Flow">
                    <asp:ListItem Text="Porteria" Value="Porteria"></asp:ListItem>
                    <asp:ListItem Text="Administradción" Value="Administradción"></asp:ListItem>
                </asp:CheckBoxList>
            </div>
        </fieldset>
        <!-- Comentarios -->
