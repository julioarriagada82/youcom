<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Home.master" AutoEventWireup="true" CodeFile="AgregarForo.aspx.cs" Inherits="Privado_Foro_AgregarForo" %>
        ...
        <div class="col-sm-12 col-md-10">
            <asp:DropDownList runat="server" ID="ddlCategoria" CssClass="form-control">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlCategoria"
                    Display="None" ErrorMessage="Por favor seleccione categoria" ValidationGroup="DatosPaso1"></asp:RequiredFieldValidator>
        </div>
    </div>
        <!-- Asunto -->
    <div class="form-group">
        <label for="nombre_iniciativa" class="col-sm-12 col-md-2 control-label">
            Titulo</label>
        <div class="col-sm-12 col-md-10">
            <asp:TextBox ID="TxtTitulo" runat="server"  CssClass="form-control" placeholder="Nombre Iniciativa"></asp:TextBox>
        </div>
    </div>
    <!-- Comentarios -->
    <div class="form-group">
