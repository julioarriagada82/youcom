<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/Home.master" AutoEventWireup="true" CodeFile="MisVentas.aspx.cs" Inherits="Privado_Mercado_MisVentas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:MultiView ID="mvwCompras" runat="server">
        <asp:View ID="View1" runat="server">
            ...
            <div class="row">
                <asp:Repeater ID="rptVentas" runat="server" OnItemCommand="rptVentas_ItemCommand" OnItemDataBound="rptVentas_ItemDataBound">
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:Literal ID="LitRutComprador" runat="server"></asp:Literal>
                            </td>
                            <td>
